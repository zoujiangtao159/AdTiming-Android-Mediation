...
final class InteractiveAdView implements View.OnAttachStateChangeListener {

    private AdWebView mAdView;

    private static final class InteractiveAdViewHolder {
        private static InteractiveAdView sInstance = new InteractiveAdView();
    }

    private InteractiveAdView() {
    }

    public static InteractiveAdView getInstance() {
        return InteractiveAdViewHolder.sInstance;
    }
...
//                    mAdView.loadUrl("about:blank");
                    mAdView.addOnAttachStateChangeListener(InteractiveAdView.this);
                } catch (Throwable e) {
    ...
    synchronized void evaluateJavascript(final String javascript) {
        ...
        HandlerUtil.runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    DeveloperLog.LogD("interactive evaluateJavascript", e);
                }
            }
        });
    }
    ...
    void addJsInterface(AdJSInterface jsInterface, String name) {
        if (jsInterface != null) {
